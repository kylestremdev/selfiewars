...
class RecentViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
  ...
  override func viewDidLoad() {
    ...
    SelfieModel.grabRecentSelfies(completionHandler: {
  ...
  func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "recentCell", for: indexPath) as! MySelfiesCustomCell
    ...
    cell.cellWinsLabel.isHidden = false
